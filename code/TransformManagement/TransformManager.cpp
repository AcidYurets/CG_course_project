...
void TransformManager::transformLightSource(shared_ptr<LightSource> lightSource, Vector3d move_params, Vector3d scale_params, Vector3d rotate_params) {
	lightSource->transform(move_params, scale_params, rotate_params);
}
